...
$sql = "SELECT * FROM admins WHERE username = '$inputUsername' ";
...
echo '</form>';
    ...
    $sql = "INSERT INTO admins (username, password_hash, first_name, last_name) VALUES ('$inputUsername',  SHA2('$inputPassword', 256), '$firstName', '$lastName');";
    $result = mysqli_query($conn, $sql);
